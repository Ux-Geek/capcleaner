...
interface LogoProps {
  ...
  className?: string;
  isRevealed?: boolean;
  bgMode?: boolean; // If true, colors are for dark bg, else for light bg
}
...
export default function Logo({ 
  ...
  const targetStroke = bgMode ? "#444444" : "#444444";
  ...
  return (
    ...
    >
      ...
      <motion.path
        ...
        animate={{ fill: isRevealed ? targetFill : bgColor }}
      ...
      <motion.path
        ...
        initial={{ stroke: bgColor, pathLength: 0 }}
        animate={{ 
          stroke: isRevealed ? targetStroke : bgColor,
          pathLength: isRevealed ? 1 : 0
        }}
        transition={{ 
          stroke: { duration: 2, ease: "easeInOut", delay: 0.5 },
